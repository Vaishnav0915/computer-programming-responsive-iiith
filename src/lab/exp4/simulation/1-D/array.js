document.getElementById("btnRanom").addEventListener("change",(randomCheckbox)=>{
    document.getElementById('userInput').disabled=randomCheckbox.target.checked
}),
document.getElementById("btnManual").addEventListener("change",(manualCheckbox)=>{
...
window.view = {
	...
	takeInputFromRadioBox: function() {
		var element = document.getElementsById('btnRandom')
